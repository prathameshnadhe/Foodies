...
const SearchRestaurantList = ({ searchText }) => {
    ...
    <div className="mx-auto my-0 w-full mobile:w-8/12 tablet:w-6/12 laptop:w-6/12 desktop:w-5/12">
      {searchList?.length === 0 ? (
        ...
        <>
          {searchList.map((restaurant) => (
            ...
            >
              ...
              >
                ...
                <div className="ml-4">
                  <p className="font-bold opacity-[0.8]">{restaurant.text}</p>
          ...
          <Link to="#">
            <div className="flex items-center m-2 p-2 py-2 hover:bg-blue-50 cursor-pointer justify-start">
              <div className="w-[64px] h-[64px]">
