...
const Shimmer = () => {
  ...
  return (
    <div className="w-10/12 grid grid-cols-1 mobile:grid-cols-2 tablet:grid-cols-3 laptop:grid-cols-4 desktop:grid-cols-5 gap-y-3 ml-auto mr-auto mt-[6rem]">
      <div className="shadow-custom bg-[#fff] w-[18rem] h-[20rem] rounded-[1rem] p-1 m-1 animate-shimmer max-mobile:h-[9rem] max-mobile:w-[20rem]">
        {showContent && (
      ...
      <div className="shadow-custom bg-[#fff] w-[18rem] h-[20rem] rounded-[1rem] p-1 m-1 animate-shimmer max-mobile:h-[9rem] max-mobile:w-[20rem]"></div>
      <div className="shadow-custom bg-[#fff] w-[18rem] h-[20rem] rounded-[1rem] p-1 m-1 animate-shimmer max-mobile:h-[9rem] max-mobile:w-[20rem]"></div>
      <div className="shadow-custom bg-[#fff] w-[18rem] h-[20rem] rounded-[1rem] p-1 m-1 animate-shimmer max-mobile:h-[9rem] max-mobile:w-[20rem]"></div>
      <div className="shadow-custom bg-[#fff] w-[18rem] h-[20rem] rounded-[1rem] p-1 m-1 animate-shimmer max-mobile:h-[9rem] max-mobile:w-[20rem]"></div>
      <div className="shadow-custom bg-[#fff] w-[18rem] h-[20rem] rounded-[1rem] p-1 m-1 animate-shimmer max-mobile:h-[9rem] max-mobile:w-[20rem]"></div>
