...
const Body = () => {
  ...
  return listOfRestaurant && listOfRestaurant.length === 0 ? (
    ...
    <div className="ml-auto mr-auto">
      ...
      <div className="w-10/12 max-tablet:w-full max-desktop:w-10/12 lg_desktop:w-9/12 grid grid-cols-1 mobile:grid-cols-2 tablet:grid-cols-3 laptop:grid-cols-4 desktop:grid-cols-5 gap-y-3 mx-auto my-0 mt-4">
